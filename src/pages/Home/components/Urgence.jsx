            ...
            <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto text-center space-y-8">
                    <div className="flex flex-col items-center justify-center gap-4 text-black">
                        <AlertCircle className="w-16 h-16 text-[#ff7a00]/80" />
                    ...
                    <div className="mt-12 bg-gradient-to-r from-[#ff7a00]/80 to-[#ff8c00] text-black p-12 rounded-3xl shadow-2xl transform hover:scale-105 transition-transform duration-300">
